...
serial.sort_values(["centroid", "danceability", "energy", "loudness", "speechiness", "acousticness", "instrumental", "liveness",  "valence", "tempo"],axis = 0, ascending = True,inplace = True)
serial.reset_index(drop=True,inplace=True)
mp.sort_values(["centroid", "danceability", "energy", "loudness", "speechiness", "acousticness", "instrumental", "liveness",  "valence", "tempo"],axis = 0, ascending = True,inplace = True)
mp.reset_index(drop=True,inplace=True)
mpi.sort_values(["centroid", "danceability", "energy", "loudness", "speechiness", "acousticness", "instrumental", "liveness",  "valence", "tempo"],axis = 0, ascending = True,inplace = True)
